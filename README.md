...
## 🧰 Software Installation and Replicability Steps

---

## Raspberry Pi / Linux-Based Unit Setup
...
sudo apt install libgl1 libglib2.0-0 libcamera-apps -y
```

Clone the repository:

```bash
git clone https://github.com/yaramahmoudd11/Bank-Security-System.git
...
```bash
cp raspberry_pi/config.example.env raspberry_pi/.env
```
...
> Important: Do not commit real API keys or private credentials.
