...
> Important: Do not commit real API keys or private credentials to a public repository.
...
#### 5. Data Statistics and Visualizations

The notebook should show visualizations for:

- Number of images per person
- Authorized vs unauthorized samples
- Alert category distribution
- Voltage readings over time
- Power outage percentage
- Control signal statistics
- Door lock/unlock action count
...
| Metric | Value |
|---|---|
| Number of enrolled users | To be filled |
